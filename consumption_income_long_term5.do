*version 3 - keep the outliers (quiet conditional statement lines on 143, 127, 111), changing name of output text on line 160
#delimit;
clear;
cap clear matrix;
cap clear mata;
...
log using 	"$code/consumption_income_long_term5.log", replace;
...
estout consumo_pp_ae2 homeprod_pp_ae2 witransfer_act_m_pp_ae2 amount_p_pp_ae2 amount_t_pr_pp_ae2 amount_borrowed_m_pp_ae2 outwage_lw_hh_pp_ae2 
	using "$out_p/consumo_w7_keep-outliers.text", stats(N mean mean_p sd prop, fmt(%9.0fc %9.3fc %9.3fc %9.3fc %9.3fc) 
