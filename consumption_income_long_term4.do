*version 3 - changing nothing about model, just viewing the coefficients on all the controls, quieting keep statement on estout regression line 162, changing name of output text on line 160
#delimit;
clear;
cap clear matrix;
cap clear mata;
...
log using 	"$code/consumption_income_long_term4.log", replace;
...
gl controls		no497 big497
				...
				dummy_dage0_7_97 dummy_dirtfloor97 dummy_electricity97 /*i.state*/;
...
estout consumo_pp_ae2 homeprod_pp_ae2 witransfer_act_m_pp_ae2 amount_p_pp_ae2 amount_t_pr_pp_ae2 amount_borrowed_m_pp_ae2 outwage_lw_hh_pp_ae2 
	using "$out_p/consumo_w7_view-all-covariates.text", stats(N mean mean_p sd prop, fmt(%9.0fc %9.3fc %9.3fc %9.3fc %9.3fc) 
