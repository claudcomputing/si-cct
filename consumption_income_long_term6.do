*version 3 - try wave change stuff, changing name of output text on line 160
#delimit;
clear;
cap clear matrix;
cap clear mata;
...
log using 	"$code/consumption_income_long_term6.log", replace;
...
estout consumo_pp_ae2 homeprod_pp_ae2 witransfer_act_m_pp_ae2 amount_p_pp_ae2 amount_t_pr_pp_ae2 amount_borrowed_m_pp_ae2 outwage_lw_hh_pp_ae2 
	using "$out_p/consumo_w6.text", stats(N mean mean_p sd prop, fmt(%9.0fc %9.3fc %9.3fc %9.3fc %9.3fc) 
